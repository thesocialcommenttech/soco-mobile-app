...
export default function Referals() {
  ...
  const [code,setCode] = useState('5UYRCH')
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.incentiveview}>
        <Text style={styles.share}>Share this code with your Friends.If anybody uses this 
          code at the time of registration to socialcomment you will receive
          exciting incentives.</Text>
      </View>
      <View style={styles.codeused}>
        <Text style={{color:'black'}}>Refferal Code used </Text>
        <Text style={{color: '#1563E2'}}>6YUOED</Text>
      </View>
