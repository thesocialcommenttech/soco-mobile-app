import { KeyboardAvoidingView, StyleSheet, Text, View,FlatList, TextInput,Platform, TouchableWithoutFeedback, ScrollView} from 'react-native'
...
export default function Interest() {
 ...
 if(!components.length){
  ...
  <>
    ...
    <Text style={styles.normaltext}>{10-Data.length} selection Left</Text>
    </View>  
    <View style={styles.bottomruler}>
    </View>
    ...
    <View style={styles.searchbox}>
          <View style={{marginTop:"4%",marginLeft:'3%',marginRight:'1.5%'}}> 
